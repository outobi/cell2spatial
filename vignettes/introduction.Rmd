---
title: "Introduction to spatial2cell Package"
author: "IPF Research Team"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to spatial2cell Package}
...
The `spatial2cell` package provides comprehensive tools for analyzing spatial transcriptomics data, with a particular focus on Idiopathic Pulmonary Fibrosis (IPF) research. This vignette demonstrates the key functions and workflows.

## Installation

```{r installation, eval=FALSE}
# Install from GitHub (when available)
devtools::install_github("your-username/spatial2cell")
